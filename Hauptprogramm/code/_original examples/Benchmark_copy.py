...
#dataclass needs to be added
#@dataclass(frozen=False) # wenn frozen = True, dann kann man die Variablen nach der Initialisierung nicht mehr ändern (d.h. fehler meldungen werden geworfen beim versuch)
